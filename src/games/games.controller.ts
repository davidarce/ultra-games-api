...
export class GamesController {
  ...
  @ApiAcceptedResponse({
    description: 'The process has been successfully triggered.',
  })
  dispatchProcess() {
  ...
  @ApiOkResponse({
    description: 'The game has been successfully returned.',
  })
  @ApiNotFoundResponse({
    description: 'The game with the id received not exits.',
  })
  ...
  @Get(':id/publisher')
  @ApiOperation({
    summary: 'Get game publisher by id game',
  })
  @ApiOkResponse({
    description: 'The publisher information has been successfully returned.',
  })
  @ApiNotFoundResponse({
    description: 'The game with the id received not exits.',
  })
  ...
  @ApiOkResponse({
    description: 'the game information has been successfully updated.',
  })
  @ApiNotFoundResponse({
    description: 'The game with the id received not exits.',
  })
